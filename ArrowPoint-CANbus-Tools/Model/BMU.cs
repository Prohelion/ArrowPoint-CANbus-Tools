...
namespace ArrowWareDiagnosticTool.Model
{
    class BMU : CanModel
    {
        ...
        public void Update(CanPacket packet)
        {
            ...
            {
                PrechargeTimer = packet.getUInt16(7);
            ...
            {
                BMUFirmwareBuildNumber = packet.getUInt16(6);
                CMUCount = packet.getUInt8(5);
                StatusFlags = packet.getUInt8(4);
                BalanceVoltageThresholdFalling = packet.getUInt16(2);
            ...
            {
                TwelveVoltCurrentCMUs = packet.getUInt16(6);
                TwelveVoltCurrentFansContactors = packet.getUInt16(4);
                FanSpeed1RPM = packet.getUInt16(2);
            ...
            if (IdMatch("FD", canOffset))
            {
                ...
                BMUHardwareVersion = packet.getInt16(4);
