...
namespace ArrowPointCANBusTool.Model
{
    ...
    {    
        ...
        public override void CanPacketReceived(CanPacket canPacket)
        {
                ...
                {
                    ChargeCellVoltageError = canPacket.GetInt16(3);
                    CellTempMargin = canPacket.GetInt16(2);
                    DischargeCellVoltageError = canPacket.GetInt16(1);
                    TotalPackCapacity = canPacket.GetUInt16(0);
                }

                if (IdMatch("F7", canOffset))
                {
                    PrechargeTimer = canPacket.GetUInt16(3);
